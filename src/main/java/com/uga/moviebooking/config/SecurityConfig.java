...
//                .permitAll().anyRequest().authenticated()); // IF APi/** permit all ELSE authorized only
        http.authorizeHttpRequests(req -> req
            .requestMatchers("/api/auth/*", "/api/movie/homepage", "/api/auth/register", "/api/user/subscribe-promotions", "/api/user/*","/api/user/unsubscribe-promotions" ,"/api/auth/login", "/api/promotion/*", "/api/promotion/apply","/api/promotion/send-promotion-email", "/api/showtime").permitAll()
